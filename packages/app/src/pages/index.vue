  ...
  <div class="bg-[#f3f1f2] min-h-screen overflow-x-hidden p-4">
    ...
    <header class=" h-[70vh] w-full relative justify-end flex flex-row items-end">
      ...
      <div class="flex flex-row justify-between w-full items-end p-8">
        <img src="../assets/pasta.png" alt="pate" class="z-10 flex relative w-[40vw] h-fit">
        <img src="../assets/recipes.png" alt="recipes" class="flex w-[22vw] h-[22vh] absolute bottom-8 right-8">
        <div class="flex flex-col relative h-fit w-[20vw] p-4 justify-between gap-5">
          <p class="z-10 text-[1.2rem] uppercase tracking-tighter"><span class="font-bold text-[2rem]">500 +</span><br>amazing recipes</p>
          <div class="flex flex-row align-center items-center z-10 justify-between w-full relative">
            ...
            <button class="uppercase bg-[#141414] border-none text-white text-xl font-medium rounded-full p-3 p-x-6 gap-4 items-center flex flex-row tracking-tighter">explore <img class="w-[1vw]" src="../assets/arrow.png" alt="arrow"></button>
          </div>
        </div>
      </div>
    </header>
      ...
      <ul class="grid grid-cols-4 gap-6 w-full p-0">
        <div v-for="recipe in recipes" :key="recipe.id"
          ...
          <div class="w-fill flex flex-col">
            <img :src="recipe.image[0].url" alt="image pate" class="w-fill h-80 min-h-80 object-cover object-bottom rounded-lg">
